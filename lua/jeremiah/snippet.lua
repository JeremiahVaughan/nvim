	...
	pickers.new({}, {
		...
		attach_mappings = function(prompt_bufnr, map)
			local function on_select()
				...
				if not file then
					print("Could not read file: " .. file_path .. " Error: " .. (err or "Unknown error"))
					return
				end
				...
				if not content then
					print("File is empty or could not be read properly: " .. file_path)
				end
				...
				if not ok then
					print("Error inserting content: " .. (err or "Unkown error"))
				end
			end
